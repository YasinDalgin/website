...
<head>
 ...
 <title>Yasin DALGIN'ın Web Sitesi</title>
...
<body 
background="https://images.pexels.com/photos/1631677/pexels-photo-1631677.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
>
		...
		<div class="container">
			...
			<form action="panel.php" method="POST">
				...
				<div class="form-group">
					...
					<input type="password" name="password" class="form-control" placeholder="Şifrenizi giriniz." required="required">
				</div>
